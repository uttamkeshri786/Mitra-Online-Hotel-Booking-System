		...
		<div class="w3-row-padding w3-padding-16 w3-text-white w3-large">
			<div class="w3-half w3-margin-bottom">
				<div class="w3-display-container">
					<img src="../images/centro-madrid.jpg" alt="Centro Madrid"
						style="width: 100%"> <span
						class="w3-display-bottomleft w3-padding">Centro Madrid</span>
				</div>
			</div>
			<div class="w3-half">
				<div class="w3-row-padding" style="margin: 0 -16px">
					<div class="w3-half w3-margin-bottom">
						<div class="w3-display-container">
							<img src="../images/Taj-Mahal.jpg" alt="India"
								style="width: 100%"> <span
								class="w3-display-bottomleft w3-padding">India</span>
						</div>
					</div>
					<div class="w3-half w3-margin-bottom">
						<div class="w3-display-container">
							<img src="../images/Christ-Redeemer-Statue.jpg" alt="Brazil"
								style="width: 100%"> <span
								class="w3-display-bottomleft w3-padding">Brazil</span>
						</div>
					</div>
				</div>
				<div class="w3-row-padding" style="margin: 0 -16px">
