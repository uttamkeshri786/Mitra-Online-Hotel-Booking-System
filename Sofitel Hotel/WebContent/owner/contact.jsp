...
<div class="w3-container" id="contact">
    ...
    <i class="fa fa-map-marker w3-text-blue" style="width:30px"></i> Punjab , India<br>
    <i class="fa fa-phone w3-text-blue" style="width:30px"></i> Phone: +918847381170<br>
    <i class="fa fa-envelope w3-text-blue" style="width:30px"> </i> Email: neelkantsingla08@gmail.com<br>
